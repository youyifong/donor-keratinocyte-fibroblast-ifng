...
**Question**: Determine if there is a statistically significant difference between asymptomatic and severe donors at each dose (6A, 6B() or at each time (6C) for each gene (CXCL10, CCL5, IL15, IL12, IFI16). Data represents three independent biological replicates for all 10 donors. 


```{r Fig 6A 6B 6C, echo=F, message=F, results='asis'}
